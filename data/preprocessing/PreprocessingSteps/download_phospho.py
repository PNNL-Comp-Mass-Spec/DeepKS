...
def get_phospho(redownload = False):
    ...
    table = table.replace("NP_001100256", "D4A7D3").replace("NP_001178933", "D3Z8E0").replace("YP_068414", "Q05608").replace("NP_001178650", "F1LYL8") # Replace incorrect uniprot IDs
    ...
    r = requests.request("GET", new_url)
    if r.status_code == 200:
    ...
    print("Number of unique uniprot IDs: ", len(table["KIN_ACC_ID"].unique()))
    table.to_excel("../../raw_data/Kinase_Substrate_Dataset_(Downloaded).xlsx", index = False)
